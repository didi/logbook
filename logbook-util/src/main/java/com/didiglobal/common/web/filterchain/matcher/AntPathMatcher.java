...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = WebUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = WebUtils.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = WebUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = WebUtils.tokenizeToStringArray(path, this.pathSeparator);
